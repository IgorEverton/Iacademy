...
const Dashboard = () =>{
      ...
      <View style={estilos.curso}>
        ...
        <Text style={{fontWeight:"bold", fontSize:10,color:"#FCFCFC"}}>MongoDB</Text>
      </View>

      <View style={estilos.curso}>
        <ImageBackground style={{margin: 5, padding: 20, alignSelf: "center"}} source={imgPy} />
          <TouchableOpacity style={estilos.botao}>Continuar de onde parou</TouchableOpacity>
        <Text style={{fontWeight:"bold", fontSize:10,color:"#FCFCFC"}}>Python completo</Text>
      </View>
      ...
      <View style={estilos.curso}>
        <ImageBackground style={{margin: 5, padding: 20, alignSelf: "center"}} source={imgRedis} />
          <TouchableOpacity style={estilos.botao}>Continuar de onde parou</TouchableOpacity>
        <Text style={{fontWeight:"bold", fontSize:10,color:"#FCFCFC"}}>Redis NoSQL</Text>
      </View>

      <View style={estilos.curso}>
        <ImageBackground style={{margin: 5, padding: 20, alignSelf: "center"}} source={imgPhp} />
          <TouchableOpacity style={estilos.botao}>Continuar de onde parou</TouchableOpacity>
        <Text style={{fontWeight:"bold", fontSize:10,color:"#FCFCFC"}}>PHP básico</Text>
      </View>
...
const estilos=StyleSheet.create({
  ...
  botao:{
    backgroundColor:"#0880A2", color:"#FCFCFC", 
